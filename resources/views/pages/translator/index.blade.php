                        ...
                        <div class="row">
                            <div class="col-lg-12 margin-tb">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-primary" href="{{ route('documents.create', '') }}"> upload new Document</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @forelse($posts as $post)
                                        <tr>
                                            <td>
                                                <a
                                                    href="{{ route('documents.edit', $post->id) }}">{{ ucfirst($post->titleen) == '' ? (ucfirst($post->titlear) == '' ? ucfirst($post->titletr) : ucfirst($post->titlear) ) : ucfirst($post->titleen) }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class='flex'>
                                                    ...
                                                    <form id="delete-frm" class=""
                                                        action="{{ route('documents.destroy', $post->id) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
