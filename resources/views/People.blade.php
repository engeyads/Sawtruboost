    ...
    <section class="section w-full boostnowform">
        <center>
            ...
            <form class='contactForm' method="post" action="/boostnow/newlead">
                ...
                <table class='formTable'>
                    ...
                    <tr align="center">
                        <td>
                            <div class='flex'>
                                <input name='area' type="text" list="area" placeholder="{{ __('messages.area') }}">
                                <datalist id="area">
                                ...
                                <input name='phone' type='tel' id="seller_phone1" placeholder="{{ __('messages.phone') }}" />
                        </td>
                        </div>
                        </td>
                        <td>
            ...
            <table class='w-full'>
                <tr>
                    <td align="center">
                        <p class="font-bold fontBlont text-left">
